...
- `magicblock-services`, `magicblock-account-cloner`, and `magicblock-task-scheduler`, which submit validator-internal transactions or consume scheduled tasks;
...
- `.agents/context/crates/magicblock-services.md` — DLP request service consumer of internal transaction scheduling.
