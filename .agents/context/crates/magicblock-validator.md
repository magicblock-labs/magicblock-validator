...
- `.agents/context/crates/magicblock-api.md` startup/shutdown sections.
...
- `.agents/context/architecture.md` and `.agents/context/crates/magicblock-api.md` for execution-domain boundaries.
