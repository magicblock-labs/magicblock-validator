...
mod process_close;
mod process_close_magic_ata;
mod process_create;
mod process_create_magic_ata;
mod process_resize;
mod validation;
...
pub(crate) use process_close_magic_ata::process_close_magic_ata;
pub(crate) use process_create::process_create_ephemeral_account;
pub(crate) use process_create_magic_ata::process_create_magic_ata;
...
fn rent_for(data_len: u32) -> Result<u64, InstructionError> {
    let total_size = u64::from(data_len)
        .checked_add(ACCOUNT_STATIC_SIZE)
