...
8. Relevant crate-specific guide under `agents/crates/` when one exists, such as `agents/crates/magicblock-chainlink.md` for `magicblock-chainlink` or `agents/crates/magicblock-metrics.md` for `magicblock-metrics`.
