...
use crate::generated::types::DelegateCompressedArgs;
use borsh::BorshDeserialize;
use borsh::BorshSerialize;

pub const DELEGATE_COMPRESSED_DISCRIMINATOR: u64 = 1;

/// Accounts.
#[derive(Debug)]
pub struct DelegateCompressed {
...
impl DelegateCompressed {
    pub fn instruction(
        &self,
        args: DelegateCompressedInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data =
            borsh::to_vec(&DelegateCompressedInstructionData::new()).unwrap();
...
pub struct DelegateCompressedInstructionData {
    discriminator: u64,
}

impl DelegateCompressedInstructionData {
    pub fn new() -> Self {
        Self { discriminator: 1 }
    }
}

impl Default for DelegateCompressedInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct DelegateCompressedInstructionArgs {
    pub args: DelegateCompressedArgs,
}

/// Instruction builder for `DelegateCompressed`.
///
/// ### Accounts:
///
...
pub struct DelegateCompressedBuilder {
    ...
    args: Option<DelegateCompressedArgs>,
    __remaining_accounts: Vec<solana_instruction::AccountMeta>,
}

impl DelegateCompressedBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn args(&mut self, args: DelegateCompressedArgs) -> &mut Self {
        self.args = Some(args);
        self
    }
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = DelegateCompressed {
        ...
        let args = DelegateCompressedInstructionArgs {
...
/// `delegate_compressed` CPI accounts.
pub struct DelegateCompressedCpiAccounts<'a, 'b> {
...
/// `delegate_compressed` CPI instruction.
pub struct DelegateCompressedCpi<'a, 'b> {
    ...
    pub __args: DelegateCompressedInstructionArgs,
}

impl<'a, 'b> DelegateCompressedCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: DelegateCompressedCpiAccounts<'a, 'b>,
        args: DelegateCompressedInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DelegateCompressed` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   4. `[]` light_system_program
#[derive(Clone, Debug)]
pub struct DelegateCompressedCpiBuilder<'a, 'b> {
    instruction: Box<DelegateCompressedCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DelegateCompressedCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DelegateCompressedCpiBuilderInstruction {
            __program: program,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = DelegateCompressedCpi {
...
#[derive(Clone, Debug)]
struct DelegateCompressedCpiBuilderInstruction<'a, 'b> {
