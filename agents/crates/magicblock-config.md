...
```bash
git diff --check -- agents/crates/magicblock-config.md agents/04_crate-map.md AGENTS.md
```

Also verify:

- `agents/crates/magicblock-config.md` exists;
...
- `agents/03_architecture.md` — startup/service orchestration and configuration ownership.
