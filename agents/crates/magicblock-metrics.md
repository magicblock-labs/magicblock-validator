...
- `agents/00_overview.md` — high-level validator purpose and hot-path caution.
- `agents/03_architecture.md` — observability as a background/service concern and cross-crate boundaries.
- `agents/04_crate-map.md` — crate ownership and consumers.
- `agents/05_testing-and-validation.md` — baseline Rust validation workflow.
