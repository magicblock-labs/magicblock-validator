...
```bash
git diff --check -- agents/crates/storage-proto.md agents/04_crate-map.md AGENTS.md
```
...
- `agents/03_architecture.md` for the local persistence layer and ledger role.
