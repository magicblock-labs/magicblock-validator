...
> **Note:** Two-stage execution (commit + finalize) is a complication of step 5. Each stage has its own signature stored separately in the `MagicIntentAccount`. This is expanded in [Instruction changes](#new-setintentexecutionstage--intent_id-stage-executionstage-).
