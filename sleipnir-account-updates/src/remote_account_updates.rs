...
pub struct RemoteAccountUpdatesWatching {
    pub account: Pubkey,
}

pub struct RemoteAccountUpdates {
    pub config: RpcProviderConfig,
    pub last_update_slots: Arc<RwLock<HashMap<Pubkey, u64>>>,
    pub monitoring_receiver: UnboundedReceiver<RemoteAccountUpdatesWatching>,
    pub monitoring_sender: UnboundedSender<RemoteAccountUpdatesWatching>,
}
