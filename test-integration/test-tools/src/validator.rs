...
pub fn start_light_validator_with_config(
    ...
    let child = wait_for_validator(validator, prover_port);
    // Waiting more because light starts the prover immediately but is not ready to serve RPC yet
