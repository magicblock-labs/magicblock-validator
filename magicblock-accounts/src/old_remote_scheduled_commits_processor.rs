...
pub struct OldRemoteScheduledCommitsProcessor {
    #[allow(unused)]
    cluster: Cluster,
    bank: Arc<Bank>,
...
#[async_trait]
impl ScheduledCommitsProcessor for OldRemoteScheduledCommitsProcessor {
...
impl OldRemoteScheduledCommitsProcessor {
    pub(crate) fn new(
        cluster: Cluster,
        bank: Arc<Bank>,
        cloned_accounts: CloneOutputMap,
