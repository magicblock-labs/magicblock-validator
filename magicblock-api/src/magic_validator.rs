...
use magicblock_chainlink::{
    ProdChainlink, ProdInnerChainlink, config::ChainlinkConfig,
...
use magicblock_program::{
    init_magic_sys,
    magicblock_processor::{CallbackEntrypoint, CrankEntrypoint, Entrypoint},
};
...
type InnerChainlinkImpl = ProdInnerChainlink;
